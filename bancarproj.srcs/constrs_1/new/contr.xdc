...
set_property -dict { PACKAGE_PIN J15   IOSTANDARD LVCMOS33 } [get_ports { reset_n }]; IO_L24N_T3_RS0_15 Sch=reset_n
set_property -dict { PACKAGE_PIN L16   IOSTANDARD LVCMOS33 } [get_ports { introduceSum }]; IO_L3N_T0_DQS_EMCCLK_14 Sch=introduceSum
set_property -dict { PACKAGE_PIN M13   IOSTANDARD LVCMOS33 } [get_ports { addFromSum }]; IO_L6N_T0_D08_VREF_14 Sch=addFromSum
set_property -dict { PACKAGE_PIN R15   IOSTANDARD LVCMOS33 } [get_ports { substractFromSum }]; IO_L13N_T2_MRCC_14 Sch=substractFromSum
set_property -dict { PACKAGE_PIN R17   IOSTANDARD LVCMOS33 } [get_ports { increaseSum1 }]; IO_L12N_T1_MRCC_14 Sch=increaseSum1
set_property -dict { PACKAGE_PIN T18   IOSTANDARD LVCMOS33 } [get_ports { increaseSum10 }]; IO_L7N_T1_D10_14 Sch=increaseSum10
set_property -dict { PACKAGE_PIN U18   IOSTANDARD LVCMOS33 } [get_ports { increaseSum100 }]; IO_L17N_T2_A13_D29_14 Sch=increaseSum100
set_property -dict { PACKAGE_PIN R13   IOSTANDARD LVCMOS33 } [get_ports { decreaseSum1 }]; IO_L5N_T0_D07_14 Sch=decreaseSum1
set_property -dict { PACKAGE_PIN T8    IOSTANDARD LVCMOS18 } [get_ports { decreaseSum10 }]; IO_L24N_T3_34 Sch=decreaseSum10
set_property -dict { PACKAGE_PIN U8    IOSTANDARD LVCMOS18 } [get_ports { decreaseSum100 }]; IO_25_34 Sch=sw[9]decreaseSum100
